...
//		}
    ...
    showVipInfo:function(){
        ...
        if(VipLevel>= 0){
            ...
            //当前等级VIP显示
            if(picPath != null){
                this.Image_now_vip.loadTexture(Common.getJinHuaResource(picPath))
            }else{
                this.Image_now_vip.loadTexture(Common.getJinHuaResource("ic_vip_0.png"));
            }
            if(VipLevel== 0){
        ...
        if(nextVipLevel>= 0){
            ...
            //当前等级VIP显示
            if(picPath != null){
                this.Image_next_vip.loadTexture(Common.getJinHuaResource(picPath))
            }else{
                this.Image_next_vip.loadTexture(Common.getJinHuaResource("ic_vip_0.png"));
            }
            if(nextVipLevel== 0){

...
//		}
    ...
    changeSex:function(id){
        ...
        //首先全部还原
        this.Image_secrecy.loadTexture(Common.getJinHuaResource("btn_xinxixiugai_xingbieweixuanzhong.png"));
        this.Image_female.loadTexture(Common.getJinHuaResource("btn_xinxixiugai_xingbieweixuanzhong.png"));
        this.Image_male.loadTexture(Common.getJinHuaResource("btn_xinxixiugai_xingbieweixuanzhong.png"));
        switch (id){
            case 0://保密
                this.Image_secrecy.loadTexture(Common.getJinHuaResource("btn_xinxixiugai_xingbiexuanzhong.png"));break;
            case 1://男
                this.Image_male.loadTexture(Common.getJinHuaResource("btn_xinxixiugai_xingbiexuanzhong.png"));break;
            case 2://女
                this.Image_female.loadTexture(Common.getJinHuaResource("btn_xinxixiugai_xingbiexuanzhong.png"));break;
        }
    },
    //初始化界面
    initData:function(){
        ...
        switch(profile_user.getSelfSex()){
            case 0://保密
                this.Image_secrecy.loadTexture(Common.getJinHuaResource("xuanzhong.png"));break;
            case 1://男
                this.Image_male.loadTexture(Common.getJinHuaResource("xuanzhong.png"));break;
            case 2://女
                this.Image_female.loadTexture(Common.getJinHuaResource("xuanzhong.png"));break;
        }
    },
    //确定
    onOk:function(){

var TableUserInfoController = BaseController.extend({
    ...
    addCallback:function(){
		...
		Frameworks.bindEventCallback("TableUserInfoLogic#", CocoStudio.getComponent(TableUserInfoLogic.view,"Image_save"), TableUserInfoLogic.callback_Image_save, BUTTON_CLICK, BUTTON_SOUND_NONE + BUTTON_ANIMATION_NONE);
    ...
    removeCallback:function(){
		...
		Frameworks.unbindEventCallback(CocoStudio.getComponent(TableUserInfoLogic.view,"TableUserInfoLogic#Image_save"), TableUserInfoLogic.callback_Image_save, BUTTON_CLICK, BUTTON_SOUND_NONE + BUTTON_ANIMATION_NONE);
